...
import LightningIco from '../images/lightning-ico.jpg';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <Link to="/" className="block" aria-label="Lightning">
              <img
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link to="https://dashboard.lightningbot.xyz" target={'_blank'} className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">Dashboard</Link>
              </li>
            </ul>
